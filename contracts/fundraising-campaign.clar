...
;; Check campaign initialization status
(define-read-only (get-initialization-status)
  {
    is-initialized: (var-get is-campaign-initialized),
    is-cancelled: (var-get is-campaign-cancelled),
    is-withdrawn: (var-get is-campaign-withdrawn)
  }
)
